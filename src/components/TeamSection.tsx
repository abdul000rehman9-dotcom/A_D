      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TEAM_MEMBERS.map((member, index) => (
            ...
            >
              {/* Monogram Box / Portrait Placeholder matching Screenshot 6 */}
              <div className="w-full aspect-[4/5] bg-[#edf0f5] flex items-center justify-center border-b border-gray-200 transition-colors group-hover:bg-[#e4e8ef]">
